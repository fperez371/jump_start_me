                    ...
                    <div className="left-featured">
                        <section>
                            ...
                            <div
                                ...
                                style={{
                                    width: `${projects[0].percentToGoal}`,
                                }}
                            />
                                    ...
                                    <div className="rec-li-div-description">
                                        ...
                                        >
                                            ...
                                            <span className="percent-funded">
                                                {projects[1].percentToGoal}%
                                                funded
                                            </span>
                                            <p className="dark-grey">
                                                by {projects[1].creator.name}
                                            </p>
                                        </Link>
                                    </div>
                                </div>
                                ...
                                <div className="rec-li-div">
                                    ...
                                    <div className="rec-li-div-description">
                                        ...
                                        >
                                            ...
                                            <span className="percent-funded">
                                                {projects[2].percentToGoal}%
                                                funded
                                            </span>
                                            <p className="dark-grey">
                                                by {projects[2].creator.name}
                                            </p>
                                        </Link>
                                    </div>
                                </div>
                                ...
                                <div className="rec-li-div">
                                    ...
                                    <div className="rec-li-div-description">
                                        ...
                                        >
                                            ...
                                            <span className="percent-funded">
                                                {projects[3].percentToGoal}%
                                                funded
                                            </span>
                                            <p className="dark-grey">
                                                by {projects[3].creator.name}
                                            </p>
                                        </Link>
                                    </div>
                                </div>
                        ...
                        <section>
                            <div className="hover-target">
                                ...
                                <div
                                    ...
                                    style={{
                                        width: `${projects[4].percentToGoal}`,
                                    }}
                                />
                            </div>
                    ...
                    <div className="rec-li-div">
                        <section>
                            ...
                            <div
                                className="funding-border-hp smaller"
                                style={{
                                    width: `${projects[5].percentToGoal}`,
                                }}
                            />
                    ...
                    <div className="rec-li-div">
                        <section>
                            ...
                            <div
                                className="funding-border-hp smaller"
                                style={{
                                    width: `${projects[6].percentToGoal}`,
                                }}
                            />
                    ...
                    <div className="rec-li-div">
                        <section>
                            ...
                            <div
                                className="funding-border-hp smaller"
                                style={{
                                    width: `${projects[7].percentToGoal}`,
                                }}
                            />
