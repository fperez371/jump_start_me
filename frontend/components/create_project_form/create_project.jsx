        ...
        <form onSubmit={this.handleSubmit} className="create-proj-form">
          <div className="proj-name-row">
            <span className="proj-name-instruction">
              Write a clear, brief title that helps people quickly understand
          ...
          <div className="categories-row">
            <div className="description-row">
              ...
              <p className="proj-categories-instruction">
                You’ll be able to change the category even after your project is
                live.
              </p>
            </div>
          ...
          <div className="create-proj-image-row">
            <div className="description-row">
              ...
              <p className="proj-categories-instruction">
                You may want to avoid including banners, badges, and text
